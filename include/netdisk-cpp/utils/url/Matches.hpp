...
namespace boost::urls
{
    ...
    template <std::size_t N = 20> class matches_storage : public matches_base
    {
            ...
            matches_storage(core::string_view matches[N], core::string_view ids[N], std::size_t n)
            {
        ...
        public:
            ...
            virtual core::string_view const* matches() const override { return matches_storage_; }
